...
/**
 * This file is used to test Thalliums MainView.
 *
 * @license AGPL3
...
class MainViewTest extends TestCase
{
    ...
    {
        $model = new \Thallium\Views\MainView;
        $this->assertInstanceOf('\Thallium\Views\MainView', $model);
     ...
     */
    public function testShow(\Thallium\Views\MainView $model)
    {
